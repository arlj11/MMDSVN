init python:
    ...
    class MGData(store.object):
        def __init__(self, Size, BSize, HasHands, HasWings, HasLegs, HasTail, HasScales, HasGills, CanSwimLong, CanFly, IsColdB, CanWeb, CanShapeshift):
        ...
        #     return MGData(Size, BSize, HasHands, HasWings, HasLegs, HasTail, HasScales, HasGills, CanSwimLong, CanFly, IsColdB, CanWeb, CanShapeshift)
