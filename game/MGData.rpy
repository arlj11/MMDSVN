init python:
    ...
    class MGData(store.object):
        def __init__(self, Size, BSize, HasHands, HasWings, HasLegs, HasTail, HasScales, HasGills, CanSwimLong, CanFly, IsColdB, CanWeb):
        ...
        #     return MGData(Size, BSize, HasHands, HasWings, HasLegs, HasTail, HasScales, HasGills, CanSwimLong, CanFly, IsColdB, CanWeb)
        
        @staticmethod
        def Lamia(Size, BSize):
            return MGData(Size, BSize, True, False, False, True, True, False, True, False, True, False)
        
        @staticmethod
        def Arachne(Size, BSize):
            return MGData(Size, BSize, True, False, True, False, False, False, False, False, False, True)
            
        @staticmethod
        def Centaur(Size, BSize):
            return MGData(Size, BSize, True, False, True, True, False, False, False, False, False, False)
            
        @staticmethod
        def Harpy(Size, BSize):
            return MGData(Size, BSize, False, True, True, False, False, False, False, True, False, False)
            
        @staticmethod
        def Slime(Size, BSize):
            return MGData(Size, BSize, True, False, True, False, False, False, False, False, False, False)
            
        @staticmethod
        def Mermaid(Size, BSize):
            return MGData(Size, BSize, True, False, False, True, True, True, True, False, False, False)
